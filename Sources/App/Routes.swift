...
public func routes(_ router: Router) throws {
    ...
    router.get("map") { req -> Future<View> in
        ...
        let data_city = ["Pleasanton", "San Francisco", "San Simeon", "San Francsico", "New York", "Paris", "Berkeley", "Llantwit Major", "Brooklyn", "San Luis Obispo", "Los Angeles", "Salinas", "Cleveland", "Gallup", "North Newton", "Morristown", "McCloud", "Venice", "New York City", "Chicago", "Rome", "Chilliocothe", "Boston", "Albuquerque", "Cambria", "La Junta", "Sacramento", "Pasadena", "Truckee", "Washington, D.C.", "Buffalo", "Washington, D. C.", "Jacksonville", "Santa Barbara", "Long Beach", "Havana", "Milano", "Madrid", "Winslow", "London", "Newton", "Santa Monica", "Washington D. C.", "New York", "Mount Vernon", "Bad Nauheim", "Chatham", "Dodge City", "Vienna", "Montello", "Oakland", "Monterey", "Mobile", "Ogden", "Chico", "Plattsburg", "Fresno"]
        let data_state = ["California", "California", "California", "California", "New York", "empty", "California", "empty", "New York", "California", "California", "California", "Ohio", "New Mexico", "Kansas", "New Jersey", "California", "empty", "New York", "Illinois", "empty", "Illinois", "Massachusetts", "New Mexico", "California", "Colorado", "California", "California", "California", "empty", "New York", "empty", "Florida", "California", "California", "empty", "empty", "empty", "Arizona", "empty", "Kansas", "California", "empty", "California", "Virginia", "empty", "empty", "Kansas", "empty", "Nevada", "California", "California", "Alabama", "Utah", "California", "New York", "California"]
        let data_country = ["United States", "United States", "United States", "United States", "United States", "France", "United States", "Wales", "United States", "United States", "United States", "United States", "United States", "United States", "United States", "United States", "United States", "Italy", "United States", "United States", "Italy", "United States", "United States", "United States", "United States", "United States", "United States", "United States", "United States", "United States", "United States", "United States", "United States", "United States", "United States", "Cuba", "Italy", "Spain", "United States", "England", "United States", "United States", "United States", "United States", "United States", "Germany", "England", "United States", "Austria", "United States", "United States", "United States", "United States", "United States", "United States", "United States", "United States"]
        let data_longitude = [-121.8746789, -122.4192363, -121.1907533, -90.0625374, -73.9871558, 2.3514992, -122.2728639, -3.4857779, -73.9495823, -120.6596156, -118.2427669, -121.6550372, -81.6934446, -108.7439489, -97.3455918, -74.4809492, -122.135266343, 12.3345898, -73.9871558, -87.6244212, 12.4853384, -82.9824019, -71.0582912, -106.6509851, -78.718852, -103.5438321, -121.4943996, -118.1444779, -120.1832533, -77.0365625, -78.8783922, -77.0365625, -81.655651, -119.7026673, -118.158049315, -82.3589631, 9.1904984, -3.7035825, -0.8819131, -0.1276474, -71.2092214, -118.4965129, -77.0365625, -73.9871558, -77.2938518934, 8.7473608, -82.191467, -100.0170787, 16.3725042, 9.805657, -122.2713563, -121.8946388, -88.0430541, -111.9738429, -121.8374777, -73.45562, -119.708861261]
        let data_latitude = [37.6624312, 37.7792808, 35.6438587, 13.7705588, 40.7308619, 48.8566101, 37.8708393, 51.4083212, 40.6501038, 35.2827525, 34.0536834, 36.6744117, 41.5051613, 35.5283573, 38.0722333, 40.7970384, 41.2497685, 45.4371908, 40.7308619, 41.8755616, 41.894802, 39.3331197, 42.3602534, 35.0841034, 40.4843583, 37.9850091, 38.5815719, 34.1476452, 39.327962, 38.8950092, 42.8867166, 38.8950092, 30.3321838, 34.4221319, 33.78538945, 23.135305, 45.4667971, 40.4167047, 51.9444399, 51.5073219, 42.3370414, 34.0250724, 38.8950092, 40.7308619, 25.05348015, 50.3681107, 42.405207, 37.7527982, 48.2083537, 45.672082, 37.8044557, 36.600256, 30.6943566, 41.2230048, 39.7284945, 44.69282, 36.7295295]

        var locArr: [Loc] = []
        for (index, element) in data_city.enumerated() {
            locArr.append(Loc(city: data_city[index], state: data_state[index], country: data_country[index], lat: data_latitude[index], long: data_longitude[index]))
        }
